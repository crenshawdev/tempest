...
couldnt-refresh = · kunde inte uppdatera
settings-source-code = Källkod
settings-report-issue = Rapportera ett problem
openmeteo-attribution = Luftkvalitetsdata från Open-Meteo
saved-locations-full = Sparade platser är full (max 8)
