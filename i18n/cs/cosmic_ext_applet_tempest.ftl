...
settings-source-code = Zdrojový kód
settings-report-issue = Nahlásit chybu
openmeteo-attribution = Data o kvalitě ovzduší od Open-Meteo
saved-locations-full = Uložená místa jsou zaplněna (max 8)
couldnt-refresh = · obnovení se nezdařilo
